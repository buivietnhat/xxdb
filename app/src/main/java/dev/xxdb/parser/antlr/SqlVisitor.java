...
public interface SqlVisitor<T> extends ParseTreeVisitor<T> {
  ...
  /**
   * Visit a parse tree produced by the {@code SimpleColumnCondition} labeled alternative in {@link
   * SqlParser#condition}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code SimpleValueCondition} labeled alternative in {@link
   * SqlParser#condition}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code OrCondition} labeled alternative in {@link
   * SqlParser#condition}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code AndCondition} labeled alternative in {@link
   * SqlParser#condition}.
   *
   * @param ctx the parse tree
   * @return the visitor result
