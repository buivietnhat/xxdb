...
public class SqlParser extends Parser {
	...
	public static final int
		...
		RULE_valueSetList = 13, RULE_valueList = 14, RULE_whereClause = 15, RULE_condition = 16, 
		RULE_operator = 17, RULE_dataType = 18, RULE_columnName = 19, RULE_tableName = 20, 
		RULE_value = 21;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"assignmentList", "assignment", "columnList", "valueSetList", "valueList", 
			"whereClause", "condition", "operator", "dataType", "columnName", "tableName", 
			"value"
		};
	}
	...
	public static class ValueSetListContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_valueSetList; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SqlVisitor ) return ((SqlVisitor<? extends T>)visitor).visitValueSetList(this);
			else return visitor.visitChildren(this);
		}
	}
